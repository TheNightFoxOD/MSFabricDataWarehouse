...
def parse_copy_activity_success(activity_result):
    ...
    try:
        ...
        success = (
            ...
            # activity_result.get('rowsCopied', 0) > 0 and -- can succeed with 0 copied rows
...
upsert_success, upsert_count = parse_notebook_success_and_count(upsert_activity, 'upsert_count')
